...
DELTA = 3.6E3;
    ...
    4(* 6,1,2,1 *),    1(* 6,1,3,1 *) = (6-2)*5*LAMBDA;
    4(* 6,1,2,1 *),    6(* 5,2,1,2 *) = 2*DELTA;
    5(* 5,2,0,2 *),    7(* 5,1,1,1 *) = (5-0)*5*LAMBDA;
    6(* 5,2,1,2 *),    8(* 5,1,2,1 *) = (5-1)*5*LAMBDA;
    6(* 5,2,1,2 *),    9(* 4,2,0,2 *) = 1*DELTA;
    7(* 5,1,1,1 *),    8(* 5,1,2,1 *) = (5-1)*5*LAMBDA;
    7(* 5,1,1,1 *),    9(* 4,2,0,2 *) = 1*DELTA;
    8(* 5,1,2,1 *),    1(* 5,1,3,1 *) = (5-2)*5*LAMBDA;
    8(* 5,1,2,1 *),   10(* 4,2,1,2 *) = 2*DELTA;
    9(* 4,2,0,2 *),   11(* 4,1,1,1 *) = (4-0)*5*LAMBDA;
   10(* 4,2,1,2 *),    1(* 4,1,2,1 *) = (4-1)*5*LAMBDA;
   10(* 4,2,1,2 *),   12(* 3,2,0,2 *) = 1*DELTA;
   11(* 4,1,1,1 *),    1(* 4,1,2,1 *) = (4-1)*5*LAMBDA;
   11(* 4,1,1,1 *),   12(* 3,2,0,2 *) = 1*DELTA;
   12(* 3,2,0,2 *),   13(* 3,1,1,1 *) = (3-0)*5*LAMBDA;
   13(* 3,1,1,1 *),    1(* 3,1,2,1 *) = (3-1)*5*LAMBDA;
   13(* 3,1,1,1 *),   14(* 2,2,0,2 *) = 1*DELTA;
   14(* 2,2,0,2 *),    1(* 2,1,1,1 *) = (2-0)*5*LAMBDA;
