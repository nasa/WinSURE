...
DELTA = 3.6E3;
     ...
     4(* 6,1,2,1 *),     1(* 6,1,3,1 DEATH  *) = (6-2)*LAMBDA;
     ...
     8(* 5,1,2,1 *),     1(* 5,1,3,1 DEATH  *) = (5-2)*LAMBDA;
     8(* 5,1,2,1 *),    10(* 4,2,1,2 *)        = 2*DELTA;
     9(* 4,2,0,2 *),    11(* 4,1,1,1 *)        = (4-0)*LAMBDA;
    10(* 4,2,1,2 *),     1(* 4,1,2,1 DEATH  *) = (4-1)*LAMBDA;
    10(* 4,2,1,2 *),    12(* 3,2,0,2 *)        = 1*DELTA;
    11(* 4,1,1,1 *),     1(* 4,1,2,1 DEATH  *) = (4-1)*LAMBDA;
    11(* 4,1,1,1 *),    12(* 3,2,0,2 *)        = 1*DELTA;
    12(* 3,2,0,2 *),    13(* 3,1,1,1 *)        = (3-0)*LAMBDA;
    13(* 3,1,1,1 *),     1(* 3,1,2,1 DEATH  *) = (3-1)*LAMBDA;
    13(* 3,1,1,1 *),    14(* 2,2,0,2 *)        = 1*DELTA;
    14(* 2,2,0,2 *),     1(* 2,1,1,1 DEATH  *) = (2-0)*LAMBDA;
