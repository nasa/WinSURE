...
RATE = 4*(LC51+F*LP);
TP = RATE/(RATE+RC);
IF RATE < 100 THEN 501,502 = RATE;
IF RATE < 100 THEN 501,400 = <1/RC,1/RC>;
IF RATE > 100 THEN 501,502 = <1/RATE,1/RATE,TP>;
IF RATE > 100 THEN 501,400 = <1/RC,1/RC,1-TP>;
...
RATE = 3*(LC41+F*LP);
TP = RATE/(RATE+RC);
IF RATE < 100 THEN 401,402 = RATE;
IF RATE < 100 THEN 401,300 = <1/RC,1/RC>;
IF RATE > 100 THEN 401,402 = <1/RATE,1/RATE,TP>;
IF RATE > 100 THEN 401,300 = <1/RC,1/RC,1-TP>;
